...
<body>
    <div class="ticket">
        <!-- Encabezado -->
        <div class="header">
            <img class="mx-auto mb-25" src="{{ public_path('image/cascante.jpg') }}" 
...
<img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=2806025143069116483965087897" 
     alt="QR Code">
