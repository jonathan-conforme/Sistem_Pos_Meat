...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
  ...
  <script>
    function marquee() {
      return {
        logos: [{
            src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/LogoUGcolor.png/960px-LogoUGcolor.png',
            alt: 'UG'
          },
          {
            src: 'https://utm.edu.ec/investigacion/images/logos/logo.png',
            alt: 'UTM'
          },
          {
          ...
          {
            src: 'https://www.upse.edu.ec/aulasvirtuales/educacion-continua/pluginfile.php/1/theme_moove/logo/1695242443/UPSE_LOGO-07.png',
            alt: 'UPSE'
          },
          {
            src: 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgYKwSEmIoDoe0iM7pVqJLn6nVStR1hkcXr0-V1ffJT3P65E8JK-OOWGd46gRT7otETHkK11M8_DelEviOX-G59b-bLimmI-QF8gSY119e7Y3mzVFHXiRBfhibQAcujUqv__10ziSC2cMY8/s1600/Logo+UNEMI+5+Estrellas.png',
            alt: 'UNEMI'
          },
          {
            src: 'https://www.idc-latinamerica.com/sites/default/files/2021-07/UEES%20Logo.png',
            alt: 'UEES'
          },
          {
            src: 'https://univercimas.com/wp-content/uploads/2021/05/Logo-de-la-Universidad-San-Francisco-de-Quito-USFQ.png',
            alt: 'USFQ'
          },
          {
            src: 'https://repositorio.unesum.edu.ec/image/logo-unesum.png',
            alt: 'UNESUM'
          },
        ],
        position: 0,
