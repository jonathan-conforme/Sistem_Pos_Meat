        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <button 
                    ...
                    class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none transition duration-150 ease-in-out"
                >
